...
* Main Page 
	...
	* Fix navigation at 1000px
	* Contact Page Link to Form at Bottom
	* Make history one text size.
	* Fix Nav Links to sit in line

* Admin Login
	* Add route
	* Add form
	* Upon logging, set with Admin privledges
	* Remove that link (admins login through a different portal)
...
* User Pages
	* Add user contact form
	* Submitting the form will enter info into uses model
