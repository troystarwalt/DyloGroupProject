...
* Main Page 
	* Check 1000px resizing (photos)
	V Fix navigation at 1000px
	V Contact Page Link to Form at Bottom (button to redirect to contact form)
	V Make history one text size.
	V Fix Nav Links to sit in line

* Admin Login
	* Add route
	* Add form
	* Upon logging, set with Admin privledges
	V Remove that link (admins login through a different portal)

* Admin Pages
	* View users model information
	* Delete and edit users

* User Pages
	V Add user contact form
	V Submitting the form will enter info into uses model
...
* Wish List
	...
	* Check all resolusions aand media sizes
